...
import headerMsgsimg from '../../assets/images/images/user/user-sm-02.jpg'
import headerLoginImage from '../../assets/images/images/user/user-xs-01.jpg'
        ...
        <>
            ...
            <header class="main-header" id="header">
                <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
                    ...
                    <span class="page-title">ERP</span>
                        ...
                        <ul class="nav navbar-nav">
                                                ...
                                                <div class="media media-sm bg-warning-10 p-4 mb-0">
                                                    <div class="media-sm-wrapper">
                                                        <a href="user-profile.html">
                                                            <img src={headerMsgsimg} alt="User Image" />
                                                        </a>
                                                    </div>
                            ...
                            <li class="dropdown user-menu">
                                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <img src={headerLoginImage} class="user-image rounded-circle" alt="User Image" />
